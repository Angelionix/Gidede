 ...
 * Backend is now served by Next.js API routes under /api/v1.
 * Handles both relative paths ("/projects/...") and already-qualified paths
 * ("/api/v1/..." from apiRoutes config) without duplication.
 */

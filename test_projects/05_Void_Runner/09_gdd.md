...
Metroidvania in space station

## Logline

A metroidvania game where every decision reshapes the world — combining Metroidvania in space station with emergent narrative consequences.

## Concept

Концепция игры «Void_Runner» — Metroidvania in space station.
...
```json
{
  ...
  "secondary": "challenge",
  "tertiary": "narrative",
  "rationale": "Primary aesthetic \"discovery\" matches genre \"metroidvania\" and idea emphasis. Secondary/tertiary chosen to broaden the player experience."
}
```

## Balance

Баланс «Void_Runner» TBD.
...
Целевая аудитория «Void_Runner» — игроки жанра Metroidvania.
...
```json
{
  ...
  "rationale": "Core dynamics derive from primary aesthetic \"discovery\" (exploration_loops, secret_finding, world_unfolding). Supporting dynamics come from secondary \"challenge\" and tertiary \"narrative\" aesthetics."
}
```

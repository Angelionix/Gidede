"""Блок 3: MDA Lab — API endpoints (алгоритм 3.3, Этапы 1–3)."""
...
class MDAAnalysisInput(BaseModel):
    """Входные данные для MDA Lab (алгоритм 3.3, Этапы 1–3)."""
...
async def analyze_mda(input_data: MDAAnalysisInput):
    """
    MDA-анализ (алгоритм 3.3, Этапы 1–3).
    ...
    Returns:
        MDAProfile с dynamics_target, mechanic_candidate_set, mechanic_set
    """

 ...
 *
 * DRY: заменяет дублирования `process.env.NEXT_PUBLIC_API_URL || "http://localhost:3030"`
 * по всему фронтенду.
 *
 * Backend теперь реализован как Next.js API routes под /api/v1.
 * API_BASE_URL пустой, чтобы apiRoutes возвращали относительные пути.
 */

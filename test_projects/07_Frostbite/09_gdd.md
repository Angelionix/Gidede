...
Survival craft in frozen wasteland

## Logline

A horror game where every decision reshapes the world — combining Survival craft in frozen wasteland with emergent narrative consequences.

## Concept

Концепция игры «Frostbite» — Survival craft in frozen wasteland.
...
```json
{
  ...
  "secondary": "narrative",
  "tertiary": "sensation",
  "rationale": "Primary aesthetic \"submission\" matches genre \"horror\" and idea emphasis. Secondary/tertiary chosen to broaden the player experience."
}
```

## Balance

Баланс «Frostbite» TBD.
...
Целевая аудитория «Frostbite» — игроки жанра Sandbox.
...
```json
{
  ...
  "rationale": "Core dynamics derive from primary aesthetic \"submission\" (routine_formation, habit_loops, flow_state). Supporting dynamics come from secondary \"narrative\" and tertiary \"sensation\" aesthetics."
}
```

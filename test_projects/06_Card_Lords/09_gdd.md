...
Deck-building card battler with procedural cards

## Logline

A strategy game where every decision reshapes the world — combining Deck-building card battler with procedural cards with emergent narrative consequences.

## Concept

Концепция игры «Card_Lords» — Deck-building card battler with procedural cards.
...
```json
{
  ...
  "secondary": "discovery",
  "tertiary": "expression",
  "rationale": "Primary aesthetic \"expression\" matches genre \"strategy\" and idea emphasis. Secondary/tertiary chosen to broaden the player experience."
}
```

## Balance

Баланс «Card_Lords» TBD.
...
Целевая аудитория «Card_Lords» — игроки жанра Strategy.
...
```json
{
  ...
  "rationale": "Core dynamics derive from primary aesthetic \"expression\" (creative_tools, customization, sandbox_building). Supporting dynamics come from secondary \"discovery\" and tertiary \"expression\" aesthetics."
}
```

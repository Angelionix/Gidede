...
Tower defense with floating fortresses

## Logline

A tower_defense game where every decision reshapes the world — combining Tower defense with floating fortresses with emergent narrative consequences.

## Concept

Концепция игры «Sky_Fortress» — Tower defense with floating fortresses.
...
```json
{
  ...
  "rationale": "Core dynamics derive from primary aesthetic \"challenge\" (skill_scaling, difficulty_curves, mastery_growth). Supporting dynamics come from secondary \"strategy\" and tertiary \"submission\" aesthetics."
}
```

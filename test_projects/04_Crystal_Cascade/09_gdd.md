...
Puzzle with rotating crystals

## Logline

A puzzle game where every decision reshapes the world — combining Puzzle with rotating crystals with emergent narrative consequences.

## Concept

Концепция игры «Crystal_Cascade» — Puzzle with rotating crystals.
...
```json
{
  ...
  "secondary": "discovery",
  "tertiary": "submission",
  "rationale": "Primary aesthetic \"challenge\" matches genre \"puzzle\" and idea emphasis. Secondary/tertiary chosen to broaden the player experience."
}
```

## Balance

Баланс «Crystal_Cascade» TBD.
...
Целевая аудитория «Crystal_Cascade» — игроки жанра Puzzle.
...
```json
{
  ...
  "rationale": "Core dynamics derive from primary aesthetic \"challenge\" (skill_scaling, difficulty_curves, mastery_growth). Supporting dynamics come from secondary \"discovery\" and tertiary \"submission\" aesthetics."
}
```
